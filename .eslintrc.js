module.exports = {
  ...
  rules: {
    ...
    'no-empty': 2, // 禁止出现空语句块  比如if else里面判断里，else中没内容，啥也不用做，写个// Todo代替下就行了
    ...
    'complexity': ["error", 100], // 指定程序中允许的最大环路复杂度  ["error", 10
    ...
    'no-loop-funcs': 0, // 禁止在循环中出现 function 声明和表达式
    ...
    'radix': 2, // 强制在parseInt()使用基数参数  常造成的原因是 parseInt没有传第二参数。
    ...
    'object-curly-spacing': [2, "never"], // 强制在大括号中使用一致的空格
